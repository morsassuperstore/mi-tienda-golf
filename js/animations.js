document.addEventListener('DOMContentLoaded', () => {
    ...
    waBtn.addEventListener('mouseenter', () => {
        ...
        waBtn.style.boxShadow = "0 8px 24px rgba(37,211,102,0.4)";
    });
